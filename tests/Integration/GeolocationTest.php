 ...
 * @uses \CrowdSecBouncer\AbstractLapiBouncer::__construct
 * @uses \CrowdSecBouncer\AbstractLapiBouncer::buildClient
 * @uses \CrowdSecBouncer\AbstractLapiBouncer::buildRemediationEngine
 *
 */
